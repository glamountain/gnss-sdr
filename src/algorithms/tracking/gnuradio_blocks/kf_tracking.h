...
typedef boost::shared_ptr<kf_tracking> kf_tracking_sptr;
...
private:
    friend kf_tracking_sptr kf_make_tracking(const Kalman_Conf &conf_);

    kf_tracking(const Kalman_Conf &conf_);
    ...
    Tracking_Kalman_filter d_carrier_kalman_filter;
